...
\text{s.t. } c = \rho \cdot w\cdot h -r + \mu\\ 
$$
The individual takes his wage $w$ as given, he chooses hours of work $h$ and consumption $c$ subject to a given non labor income $\mu$ as well as a tax regime defined by $\rho,r$.
