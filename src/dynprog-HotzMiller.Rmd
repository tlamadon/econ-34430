...
The risk aversion coefficient does not enter linearly in the utility problem. We are going to fix it, and use Hotz and Miller conditional on that value. So Assume that $\rho$ is known and fixed at some value. We need to construct our expressions that will help us recover $u(a=2)$ and $U(a=3)$ in this dynamic case.
