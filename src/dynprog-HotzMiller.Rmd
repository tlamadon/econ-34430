...
$$ 
\begin{align*}
\bar{V}_T(x) &=  \mathbb{E} \max_a \Big[ \gamma \cdot S \cdot u_0(\mathbb{E}[\log w|x,t]) + u(a) \Big] \\
&= \sum_a Pr[a|x,t] \Big(  \gamma \cdot S \cdot u_0(\mathbb{E}[\log w|x,t]) + u(a) + \gamma_c - \log Pr[a|x,t] \Big) \\
&= \gamma \cdot \Big( \sum_a Pr[a|x,t] \cdot S \cdot u_0(\mathbb{E}[\log w|x,t]) \Big)  + u(a) \cdot \Big( \sum_a Pr[a|x,t] \cdot S \cdot u_0(\mathbb{E}[w|x,t]) \Big)  \\
...
$$ 
\begin{align*}
\bar{V}_{t} &= \log \sum_a \exp \Big[   S \cdot u_0(\mathbb{E}_{t} \log w_{t}) + u(a) + \beta \cdot G(a) \times \bar{V}_{t+1} \Big] + \gamma_c \\
